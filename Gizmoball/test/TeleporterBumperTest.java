...
public class TeleporterBumperTest {
	TeleporterBumper tBump;
	
	@Before
	public void setUp() throws Exception {
		tBump = new TeleporterBumper(0,0,0,"tp1");
	}

	@Test
	public void nameTest() {
		assertEquals(tBump.getName(),"tp1");
	}
	...
	public void colorTest() {
		assertEquals(tBump.getColor(),Color.CYAN);
	...
	public void lineSegmentTest() {
		...
		assertFalse(lines==null);
		assertTrue(lines.size()==3);
		assertEquals(lines.get(0),new LineSegment(tBump.getX()+20,tBump.getY()+20,tBump.getX(),tBump.getY()+20));
	}
